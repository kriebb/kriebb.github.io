...
![](./images/dependency_injection_sequence_diagram.png)
```mermaid
sequenceDiagram
...
[![Event Logs](./images/azure_application_event_logs.png)](https://thebernardlim.com/azure-app-service-event-logs/)
