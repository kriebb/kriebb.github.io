...
datePublished: 2023-03-26T08:20:34.000Z
...
- [Hacking JWT Tokens: Bruteforcing Weak Signing Key (JWT-Cracker)](https://blog.pentesteracademy.com/hacking-jwt-tokens-bruteforcing-weak-signing-key-jwt-cracker-5d49d34c44): An excellent read that demonstrates the importance of employing an RSA method for validating your tokens.
- [Critical vulnerabilities in JSON Web Token libraries](https://auth0.com/blog/critical-vulnerabilities-in-json-web-token-libraries/): A valuable read from Auth0, covering various vulnerabilities associated with JSON Web Tokens.
...
## JSON Security Practices Comparison

| Security Practice | Protection Level | Implementation Complexity | Risks if Omitted |
|-------------------|------------------|---------------------------|------------------|
| Whitelist Models | High | Medium | Arbitrary object deserialization |
| Data Annotations | Medium | Low | Improper input validation |
| Custom Converters | High | High | Type confusion attacks |
| System.Text.Json | Medium-High | Low | Fewer vulnerabilities than Newtonsoft |
| Input Sanitization | Medium | Medium | Cross-site scripting, injection attacks |
...
```json
{
    ...
    "name": "crazy",
    "$type": "System.Diagnostics.Process, System.Diagnostics",
    "StartInfo": {
    "FileName": "cmd.exe",
    "Arguments": "test > test.txt",
...
![Security t-shirt](https://media.licdn.com/dms/image/C5622AQHDe9YOhXXTXQ/feedshare-shrink_1280/0/1679182669921?e=1682553600&v=beta&t=7ZgafBGhdupr6okYSJD65g2IGQpJu_Ef6u238dq9Ph8)
